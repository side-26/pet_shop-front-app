...
<Example resizable>
  {
    <div className="grid grid-cols-1">
      ...
      <div className="col-start-1 row-start-1 flex gap-4 rounded-lg font-mono text-sm leading-6 font-bold text-white">
        ...
        <div className="flex size-14 grow items-center justify-center rounded-lg bg-sky-500 p-4">
          02
        </div>
...
<Example resizable>
  {
    <div className="grid grid-cols-1">
      ...
      <div className="col-start-1 row-start-1 flex gap-4 rounded-lg font-mono text-sm leading-6 font-bold text-white">
        ...
        <div className="flex size-14 grow-7 items-center justify-center rounded-lg bg-indigo-500 p-4">
          02
        </div>
...
<Example resizable>
  {
    <div className="grid grid-cols-1">
      ...
      <div className="col-start-1 row-start-1 flex gap-4 rounded-lg font-mono text-sm leading-6 font-bold text-white">
        ...
        <div className="flex size-14 shrink-0 grow-0 items-center justify-center rounded-lg bg-pink-500">
          02
        </div>
