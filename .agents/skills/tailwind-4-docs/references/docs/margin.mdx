...
<Example>
  {
    <div className="flex justify-center font-mono text-sm leading-6 font-bold text-white">
      <div className="flex flex-col items-center">
        ...
        <div className="relative -mt-8 flex items-center justify-center rounded-md bg-sky-500 p-4">
          -mt-8
        </div>
      </div>
    </div>
...
<Example>
  {
    <div className="flex justify-start font-mono text-sm leading-6 font-bold text-white">
      <div className="relative flex space-x-4 rounded-lg">
        ...
        <div className="relative flex h-14 w-14 items-center justify-center rounded-lg bg-fuchsia-500">
          01
        </div>
        <div className="relative flex h-14 w-14 items-center justify-center rounded-lg bg-fuchsia-500">
          02
...
<Example>
  {
    <div className="flex justify-end font-mono text-sm leading-6 font-bold text-white">
      <div className="relative flex flex-row-reverse space-x-4 space-x-reverse rounded-lg">
        ...
        <div className="relative flex h-14 w-14 items-center justify-center rounded-lg bg-cyan-500">
          01
        </div>
        <div className="relative flex h-14 w-14 items-center justify-center rounded-lg bg-cyan-500">
          02
...
<CustomizingYourSpacingScale
  utilities={['m', 'mx', 'my', 'ms', 'me', 'mbs', 'mbe', 'mt', 'mr', 'mb', 'ml']}
/>
