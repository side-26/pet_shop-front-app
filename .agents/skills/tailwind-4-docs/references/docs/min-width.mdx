...
<Example>
  {
    <div className="relative grid justify-items-start gap-y-4 text-center font-mono text-xs font-bold text-white">
      ...
      <div className="relative hidden min-w-lg rounded-lg bg-blue-500 px-4 py-2 sm:block">
        min-w-lg
      </div>
      <div className="relative hidden min-w-md rounded-lg bg-blue-500 px-4 py-2 sm:block">
        min-w-md
      </div>
      <div className="relative hidden min-w-sm rounded-lg bg-blue-500 px-4 py-2 sm:block">
        min-w-sm
      </div>
