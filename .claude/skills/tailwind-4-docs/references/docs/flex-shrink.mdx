...
<Example resizable>
  {
    <div className="grid grid-cols-1">
      ...
      <div className="col-start-1 row-start-1 flex gap-4 rounded-lg font-mono text-sm leading-6 font-bold text-white">
        ...
        <div className="flex h-14 w-64 shrink items-center justify-center rounded-lg bg-sky-500 p-4">
          02
        </div>
...
<Example resizable>
  {
    <div className="grid grid-cols-1">
      ...
      <div className="col-start-1 row-start-1 flex gap-4 rounded-lg font-mono text-sm leading-6 font-bold text-white">
        ...
        <div className="flex w-16 shrink-0 items-center justify-center rounded-lg bg-blue-500 p-4 sm:w-64">
          02
        </div>
