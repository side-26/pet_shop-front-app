...
<Example resizable>
  {
    <div className="grid grid-cols-1">
      ...
      <div className="col-start-1 row-start-1 flex gap-4 rounded-lg font-mono text-sm leading-6 font-bold text-white">
        ...
        <div className="flex w-64 flex-1 items-center justify-center rounded-lg bg-pink-500 p-4">
          02
        </div>
        <div className="flex w-32 flex-1 items-center justify-center rounded-lg bg-pink-500 p-4">
          03
        </div>
      </div>
    </div>
...
<Example resizable>
  {
    <div className="grid grid-cols-1">
      ...
      <div className="col-start-1 row-start-1 flex gap-4 rounded-lg font-mono text-sm leading-6 font-bold text-white">
        ...
        <div className="flex-none last:pr-8 sm:last:pr-0">
          <div className="flex w-32 items-center justify-center rounded-lg bg-indigo-500 p-4">
            02
          </div>
        </div>
