...
<Example>
  {
    <div className="grid grid-cols-1">
      ...
      <div className="col-start-1 row-start-1 grid grid-flow-row-dense grid-cols-3 grid-rows-3 gap-4 rounded-lg text-center font-mono text-sm leading-6 font-bold text-white">
        <div className="col-span-2 rounded-lg bg-purple-300 p-4 dark:bg-purple-800 dark:text-purple-400">
          01
        </div>
        <div className="col-span-2 rounded-lg bg-purple-300 p-4 dark:bg-purple-800 dark:text-purple-400">
          02
...
<ResponsiveDesign
  ...
  defaultClass="grid grid-flow-col"
  featuredClass="grid-flow-row"
/>
