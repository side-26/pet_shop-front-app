...
import {
  ...
  html,
  css,
} from '@/components/code-example.tsx';
...
<Example>
  {
    ...
    >
      <div className="flex items-center space-x-3">
        ...
        <div className="text-sm font-semibold text-gray-900 group-hover:text-white dark:text-white">
          New project
        </div>
      </div>
          ...
          <div className="flex gap-4">
            ...
            <div className="w-full text-sm leading-6">
              <a href="#" className="font-semibold text-gray-900 dark:text-white">
                <span className="absolute inset-0 rounded-xl" aria-hidden="true"></span>Leslie
                Abbott
              </a>
...
<Example className="py-0">
  {
    <div className="px-6">
      <div className="mx-auto max-w-lg border-x border-x-gray-200 px-6 py-8 text-gray-700 selection:bg-fuchsia-300 selection:text-fuchsia-900 dark:border-x-gray-800 dark:bg-gray-950/10 dark:text-gray-300">
        <p>
          So I started to walk into the water. I won't lie to you boys, I was terrified. But I
          pressed on, and as I made my way past the breakers a strange calm came over me. I don't
          know if it was divine intervention or the kinship of all living things but I tell you
...
<div class="selection:bg-fuchsia-300 selection:text-fuchsia-900">
  <p>
    ...
    and as I made my way past the breakers a strange calm came over me. I don't know if it was
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2">
      <div className="p-8 pt-7">
        ...
        <div className="rounded-lg bg-white px-6 py-8 shadow-xl ring-1 ring-gray-900/5">
          ...
          {/* This is not an h3 because we're converting h3's to links in MDX files */}
          <div className="mt-5 text-base font-medium tracking-tight text-gray-900">
            Writes upside-down
          </div>
...
<Example>
  {
    <fieldset aria-label="Choose a memory option" className="mx-auto max-w-md">
      <div className="flex items-center justify-between">
        ...
        <a
          href="#"
          className="text-sm/6 font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400"
        >
...
<fieldset aria-label="Choose a memory option">
  ...
  <div
    class="mt-4 grid grid-cols-6 gap-2 pointer-coarse:mt-6 pointer-coarse:grid-cols-3 pointer-coarse:gap-4"
  >
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            <span className="text-gray-400">&</span>:is(:where(.group)
      ...
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            <span className="text-gray-400">&</span>:is(:where(.peer)
            <span className="text-gray-400">...</span> ~ *)
          </code>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            :where(<span className="text-gray-400">...</span>){' '}
            <span className="text-gray-400">&</span>
          </code>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            <span className="text-gray-400">&</span>:nth-child(
            <span className="text-gray-400">...</span>)
          </code>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            <span className="text-gray-400">&</span>:nth-last-child(
            <span className="text-gray-400">...</span>)
          </code>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            <span className="text-gray-400">&</span>:nth-of-type(
            <span className="text-gray-400">...</span>)
          </code>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            <span className="text-gray-400">&</span>:nth-last-of-type(
            <span className="text-gray-400">...</span>)
          </code>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            <span className="text-gray-400">&</span>::marker,{' '}
            <span className="text-gray-400">&</span> *::marker
          </code>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            <span className="text-gray-400">&</span>[aria-
      ...
      <tr>
        ...
        <td>
          <code className="whitespace-nowrap before:content-none after:content-none">
            <span className="text-gray-400">&</span>[data-
            <span className="text-gray-400">&hellip;</span>]
          </code>
        </td>
      </tr>
