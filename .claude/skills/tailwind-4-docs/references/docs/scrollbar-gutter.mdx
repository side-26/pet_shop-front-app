...
<Example>
  {
    <div className="mx-auto grid max-w-xl grid-cols-1 gap-6 text-sm/6 text-gray-600 sm:grid-cols-2 dark:text-gray-300">
      <div>
        <p className="mb-3 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">
          scrollbar-gutter-auto
        </p>
        <div className="h-40 scrollbar-gutter-auto overflow-auto rounded-lg bg-gray-50 py-4 dark:bg-white/5">
          <p className="text-justify">
            Hey everyone! It’s almost 2027 and we still don’t know if there are aliens living among
            us, or do we? Maybe the person writing this is an alien. You will never know.
          </p>
        </div>
      </div>
      <div>
