...
export const description = 'Utilities for styling the stroke of SVG elements.';
...
<Figure hint="Hover over the button to see the stroke color change">
...
<ResponsiveDesign
  element="svg"
  property="stroke"
  defaultClass="stroke-cyan-500"
  featuredClass="stroke-cyan-700"
/>
