...
import { initialCartItems, type CartItem } from './cart-data';
...
export function CartPageContent() {
  const [items, setItems] = useState<readonly CartLine[]>(initialCartItems);
          ...
          >
            ...
            {items.map((item) => (
              <Card
                ...
                variant="elevated"
                size="sm"
                className="tw:lg:shrink-0 tw:lg:py-2"
              >
