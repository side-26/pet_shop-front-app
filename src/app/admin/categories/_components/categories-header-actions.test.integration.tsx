...
describe('CategoriesHeaderActions', () => {
  it('keeps create and reload visible through the inclusive order limit', async () => {
    render(
      <DirectionProvider direction="rtl">
        <AdminLayoutShellView pathname={routePaths.adminCategories}>
          <CategoriesHeaderActions petTypes={[]} />
        </AdminLayoutShellView>
      </DirectionProvider>,
    );

    expect(await screen.findByRole('button', { name: 'افزودن دسته‌بندی' })).toBeTruthy();
